 ...
 */
function boilerplate_prepare_theme_for_pixtypes() {
	/**
	 * ACTIVATION SETTINGS
	...
	$types_options['boilerplate_pixtypes_theme'] = $pixtypes_conf_settings;
...
add_action( 'after_switch_theme', 'boilerplate_prepare_theme_for_pixtypes' );
...
if ( ! class_exists( 'wpgrade' ) ) :
	...
	function wpgrade_callback_geting_active() {
		boilerplate_prepare_theme_for_pixtypes();
	}
