...
class Pixelgrade_Starter {
	...
	public function enqueue_scripts() {
		...
		wp_register_script( 'pixelgrade_starter-scripts', pixelgrade_get_theme_file_uri( 'components/starter/js/front.js' ), array( 'jquery' ), $this->_assets_version, true );
	...
	public function admin_init() {
		...
		wp_register_style( 'pixelgrade_starter-admin-style', pixelgrade_get_theme_file_uri( 'components/starter/css/admin.css' ), array(), $this->_assets_version );
		wp_register_script( 'pixelgrade_starter-admin-scripts', pixelgrade_get_theme_file_uri( 'components/starter/js/admin.js' ), array(), $this->_assets_version );
