...
/**
 * Load our global Pixelgrade functions
 */
require_once( get_template_directory() . '/components/pixelgrade-functions.php' );

/**
 * Load our global Pixelgrade template tags
 */
require_once( get_template_directory() . '/components/pixelgrade-template-tags.php' );
...
function Pixelgrade_Gallery_Settings() {
	...
	if ( ! class_exists( 'Pixelgrade_Gallery_Settings') ) {
		pixelgrade_load_component_file( 'gallery', 'class-gallery-settings' );
	}
