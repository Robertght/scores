...
class Pixelgrade_Multipage {
	...
	public function enqueue_scripts() {
		...
		wp_register_script( 'pixelgrade_multipage-scripts', pixelgrade_get_theme_file_uri( 'components/multipage/js/jquery.bully.js' ), array( 'jquery' ), $this->_assets_version, true );
