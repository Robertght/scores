<?php
/**
 * Various Pixelgrade components functions.
 *
 ...
 * @return string
 */
function pixelgrade_locate_component_file( $component_slug, $slug, $name = '' ) {
	$template = '';
	...
	return apply_filters( 'pixelgrade_locate_component_file', $template, $component_slug, $slug, $name );
}
