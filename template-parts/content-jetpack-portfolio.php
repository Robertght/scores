	...
	<article id="post-<?php the_ID(); ?>" <?php post_class() ?>>
		<div class="c-card">
			...
			<div class="c-card__content">
				...
				$portfolio_items_primary_meta   = pixelgrade_option( 'portfolio_items_primary_meta', 'category', false );
				$portfolio_items_secondary_meta = pixelgrade_option( 'portfolio_items_secondary_meta', 'date', false );
				...
				<?php if ( pixelgrade_option( 'portfolio_items_title_visibility', true ) ) { ?>
